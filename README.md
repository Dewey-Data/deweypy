...
By default, data downloads to `./dewey-downloads`. To use a different directory:

```bash
python -m deweypy --api-key  --download-directory /path/to/directory speedy-download
```
